...
class Line extends DisplayObject {
  constructor(
    ...
    //Assign the argument values to this sprite
    Object.assign(
        this, {strokeStyle, lineWidth, ax, ay, bx, by, lineInfo}
    );
  ...
  render(ctx) {
    ...
    if(this.lineInfo) ctx.setLineDash(this.lineInfo)
    if (this.strokeStyle !== "none") ctx.stroke();
  }
}

//A higher level wrapper for the line sprite
export function line(strokeStyle, lineWidth, ax, ay, bx, by, lineInfo) {
  //Create the sprite
  let sprite = new Line(strokeStyle, lineWidth, ax, ay, bx, by, lineInfo);
